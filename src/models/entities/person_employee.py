class PersonEmployee:
    def __init__(self, employee_name: str, employee_cpf: str, employee_address: str, employee_telephone: str,employee_level_permission: int, employee_password: str, employee_admission_date: str, employee_id: int = None):
        ...
        self.employee_level_permission = employee_level_permission
    ...
    def __repr__(self):
        return (f"PersonEmployee("
                ...
                f"permission_level={self.employee_level_permission}, admission_date='{self.employee_admission_date}')")
