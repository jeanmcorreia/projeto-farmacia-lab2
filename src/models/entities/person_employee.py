class PersonEmployee:
    def __init__(self, employee_id: int, employee_name: str, employee_cpf: int, employee_address: str, employee_telephone: int,employee_permission_level: int,employee_password: hash, employee_admission_date):
